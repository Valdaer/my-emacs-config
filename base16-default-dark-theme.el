...
;; This file was generated by base16-builder and modified with entries regarding company-mode
...
(let ((base00 "#181818")
  ...
  (custom-theme-set-faces 
   ...
   `(company-tooltip ((t (:background "#d6dce4" :foreground ,base00))))
   `(company-scrollbar-bg ((t (:background ,base05))))
   `(company-scrollbar-fg ((t (:background ,base0E))))
   `(company-tooltip-selection ((t (:background ,base0E :foreground ,base00))))
   `(company-tooltip-common ((t (:background "#d6dce4" :foreground ,base08))))
   `(company-tooltip-common-selection ((t (:inherit company-tooltip-selection :foreground ,base08))))
   `(company-tooltip-annotation ((t (:inherit company-tooltip :foreground ,base08))))
   `(company-preview ((t (:background ,base03 :foreground ,base0A))))
   `(company-preview-common ((t (:background ,base03 :foreground ,base0A))))
